...
var prepareRequest = function(parsedPomfile) { // object containing requestline, headers, querystringparams, httpom_directives and body
  ...
  function addRequiredVariablesForTemplateString(templateEngine, template) {
    if (templateEngine === 'mustache') {
      ...
      requiredVariables = requiredVariables.concat(_.uniq(flattened_parsed.reduce(function(memo, v, i){
  ...
  var retval = {
    ...
    preRequestFunctions: preRequestFunctions,
